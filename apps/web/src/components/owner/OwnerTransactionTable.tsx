      ...
      <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-start">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm leading-relaxed text-slate-500">
            Pantau transaksi dan pencairan dana dari seluruh outlet Anda secara real-time.
          </p>
        </div>
      ...
      <div className="mt-5 border-y border-slate-100 py-4">
        <div className="flex flex-col gap-3 xl:flex-row xl:items-center justify-between">
          <div className="flex flex-wrap items-center gap-2">
            <span className="shrink-0 text-xs font-extrabold text-[#0A2540] mr-1 font-sans">
              Filter transaksi:
            </span>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none rounded-xl border border-slate-200 bg-white py-2 pl-3 pr-8 text-[11px] font-extrabold text-slate-700 outline-none transition focus:border-[#00C897]"
              >
                <option value="all">Semua metode</option>
                <option value="cash">Tunai / Cash</option>
                <option value="qris">QRIS TUNTAS</option>
                <option value="card">SoftPOS / Kartu</option>
            ...
            <div className="flex flex-wrap items-center gap-2">
              <label className="inline-flex items-center gap-1.5">
                ...
                <input
                  ...
                  className="rounded-xl border border-slate-200 bg-white px-2.5 py-1.5 text-[11px] font-semibold text-slate-700 outline-none focus:border-[#00C897]"
                />
              </label>
              <label className="inline-flex items-center gap-1.5">
        ...
        <div className="flex flex-col items-center justify-between gap-3 border-t border-slate-100 px-4 py-3 sm:flex-row">
          <label className="flex items-center gap-2 text-[11px] font-semibold text-slate-500">
            ...
            <select
              ...
              className="appearance-none rounded-lg border border-slate-200 bg-white px-2 py-1 text-[11px] font-bold text-slate-700 outline-none focus:border-[#00C897]"
            >
          ...
          <div className="flex items-center gap-2">
            <button
              disabled
              className="rounded-lg border border-slate-200 px-2.5 py-1.5 text-[11px] font-extrabold text-[#0A2540] hover:bg-slate-50 disabled:opacity-40"
            >
      ...
      <div className="mt-5 rounded-2xl border border-blue-100 bg-blue-50/50 p-4">
        ...
        >
          <span className="flex items-center gap-1.5 text-xs font-extrabold text-blue-900 font-sans">
            ...
            Bagaimana membaca status transaksi & pencairan?
          </span>
          <ChevronDown
